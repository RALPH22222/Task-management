...
<body>
    <div class="d-flex">
        <?php $active='dashboard'; include __DIR__ . '/assets/sidebar/sidebar.php'; ?>
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="card stats-card h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="card-title">Overdue Projects</h6>
                                        <p class="display-6"><?php echo $projectsOverdueCount; ?></p>
                                    </div>
