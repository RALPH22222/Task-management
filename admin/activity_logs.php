...
<head>
  ...
  <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" rel="stylesheet" integrity="sha512-SnH5WK+bZxgPHs44uWIX+LLJAJ9/2Pkf6Z5xQ4bC0r0n4l9F6vS5WQ3G6s3b3P1l2QxGZkT8aGQdQW2w2i8xwA==" crossorigin="anonymous" referrerpolicy="no-referrer"/>
...
<body>
  <div class="d-flex">
    <?php $active='logs'; include __DIR__ . '/inc/sidebar.php'; ?>
            ...
            <form class="row g-3 align-items-end" method="get" action="">
              ...
              <div class="col-12 col-md-12">
                <?php if ($q!=='' || $userId!=='' || $dateFrom!=='' || $dateTo!==''): ?>
                  <a href="activity_logs.php" class="btn btn-outline-secondary btn-sm"><i class="fa fa-rotate-left me-1"></i>Reset</a>
                <?php endif; ?>
              </div>
            </form>
          </div>
